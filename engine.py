...
image3 = face_recognition.load_image_file(os.path.abspath("recognize/images/farah1.png"))
image3_face_encoding = face_recognition.face_encodings(image3)[0]

image4 = face_recognition.load_image_file(os.path.abspath("recognize/images/alex1.png"))
image4_face_encoding = face_recognition.face_encodings(image4)[0]

image5 = face_recognition.load_image_file(os.path.abspath("recognize/images/elon.jpg"))
image5_face_encoding = face_recognition.face_encodings(image5)[0]

image6 = face_recognition.load_image_file(os.path.abspath("recognize/images/zuck.jpg"))
image6_face_encoding = face_recognition.face_encodings(image6)[0]

image7 = face_recognition.load_image_file(os.path.abspath("recognize/images/messi.jpg"))
image7_face_encoding = face_recognition.face_encodings(image7)[0]

image_8 = face_recognition.load_image_file(os.path.abspath("recognize/images/bill.jpg"))
