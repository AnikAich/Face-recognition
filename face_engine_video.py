...
image_zuck_1 = face_recognition.load_image_file(os.path.abspath("recognize/images/zuck.jpg"))
image_messi_1 = face_recognition.load_image_file(os.path.abspath("recognize/images/messi.jpg"))
image_bill_1 = face_recognition.load_image_file(os.path.abspath("recognize/images/bill.jpg"))
...
zuck_face_1 = face_recognition.face_encodings(image_zuck_1)[0]
messi_face_1 = face_recognition.face_encodings(image_messi_1)[0]
bill_image_1 = face_recognition.face_encodings(image_bill_1)[0]
...
# encoding.
known_faces = [
    alex_face_1, badguy_face_1, farah_face_1, laswell_face_1, price_face_1, zuck_face_1, messi_face_1, bill_image_1
]
